...
router.get('/get/html', function(req, res) {
    ...
    var xml = fs.readFileSync('CCTcafe.xml', 'utf8'); //We are reading in the XML file
    var xsl = fs.readFileSync('CCTcafe.xsl', 'utf8'); //We are reading in the XSL file
...
router.post('/post/json', function(req, res) {
  ...
  function appendJSON(obj) {
    ...
    xmlFileToJs('CCTcafe.xml', function(err, result) {
      if (err) throw (err);
      ...
      jsToXmlFile('CCTcafe.xml', result, function(err) {
